...
<html lang="en">
    ...
    <body>
        ...
        <button onclick="location.href='./form-book.jsp';">Create author</button>
        <button onclick="location.href='./form-customer.jsp';">Create author</button>
        <button onclick="location.href='./form-rent.jsp';">Create author</button>
